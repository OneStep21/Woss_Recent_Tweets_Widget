<?php
class Woss_Recent_Tweets_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            'Recent Tweets', // Name
            array( 'description' => __( 'Display latest Tweets from Twitter.', 'woss' ), ) // Args
        );
    }
    ...
    function form( $instance ) {
        ...
        <p><label for="<?php echo $this->get_field_id('consumer_key'); ?>"><?php _e('Consumer Key','woss') ?></label><br />
        ...
        <p>
            <label for="<?php echo $this->get_field_id('consumer_secret') ?>"><?php _e('Consumer Secret', 'woss') ?></label><br />
        ...
        <p><label for="<?php echo $this->get_field_id('query') ?>"><?php _e('Search Query (<a href="https://dev.twitter.com/docs/using-search" target="_blank" title="Read more about Twitter Search query">?</a>)','woss') ?></label><br />
        ...
        <p><label for="<?php echo $this->get_field_id('number') ?>"><?php _e('Number of Tweets','woss') ?></label>&nbsp;<input type="text" name="<?php echo $this->get_field_name
        ...
        <p><label for="<?php echo $this->get_field_id('show_follow') ?>">
                ...
                <?php _e('Show Follow Button?', 'woss') ?></label>
        </p>
        <p><label for="<?php echo $this->get_field_id('show_account') ?>">
                ...
                <?php _e('Show Account Info?', 'woss') ?></label>
        </p>
        <p><label for="<?php echo $this->get_field_id('show_avatar') ?>">
                ...
                <?php _e('Show User Avatar?', 'woss') ?></label>
        </p>
...
function wp_load_widget() {
    register_widget( 'Woss_Recent_Tweets_Widget' );
}
